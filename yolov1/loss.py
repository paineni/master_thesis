...
class YoloLoss(nn.Module):
    ...
    def forward(self, predictions, target):
        ...
        iou_b1 = intersection_over_union(
            predictions[..., 3:7], target[..., 3:7]
        )
        iou_b2 = intersection_over_union(
            predictions[..., 8:12], target[..., 3:]
        )
        ...
        pred_box = (
            bestbox * predictions[..., 7:8]
            + (1 - bestbox) * predictions[..., 2:3]
        )
        ...
        no_object_loss = self.mse(
            torch.flatten(
                (1 - exists_box) * predictions[..., 2:3], start_dim=1
            ),
        ...
        no_object_loss += self.mse(
            torch.flatten(
                (1 - exists_box) * predictions[..., 7:8], start_dim=1
            ),
            torch.flatten((1 - exists_box) * target[..., 2:3], start_dim=1),
        )
